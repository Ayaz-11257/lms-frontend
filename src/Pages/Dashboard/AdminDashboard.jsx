        ...
        <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white">
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        ...
                        <div className="flex items-center justify-between p-5 gap-5 rounded-md shadow-md">
                            <div className="flex flex-col items-center">
                                ...
                                <h3 className="text-4xl font-bold">{allPayments?.count * 500}</h3>
                            </div>
            ...
            <div className="mx-[10%] w-[80%] self-center flex flex-col items-center justify-center gap-10 mb-10">
                <div className="flex w-full items-center justify-between">
                    ...
                    <button className="w-fit bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 rounde py-2 px-4 font-semibold text-lg cursor-pointerz" onClick={() => {
                            ...
                            return(
                                <tr key={course._id}>
                                    ...
                                    <td className=" overflow-hidden text-ellipsis whitespace-nowrap">
                                        {/* max-w-28 recommended for description */}
                                    ...
                                    <td className="flex items-center gap-4">
                                        ...
                                        <button className="bg-red-500 hover:bg-red-600 transition-all ease-in-out duration-300 text-xl py-2 px-4 rounded-md font-bold" onClick={() => onCourseDelete(course?._id)}>
                                            <BsTrash />
                                        </button>
                                    </td>
                                </tr>
